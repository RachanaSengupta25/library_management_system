            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
						...
						<li class="active"><a href="/LIBRARY%20MANAGEMENT%20SYSTEM/library/ADD/index">Add Book</a></li>
						<li><a href="/LIBRARY%20MANAGEMENT%20SYSTEM/library/ADD/index">Remove Book</a></li>
                        <li><a href="/LIBRARY%20MANAGEMENT%20SYSTEM/library/ISSUE/PHP_CRUD/index">Issue Book</a></li>
				...
				while($row = $result->fetch_assoc()) {
					echo "<tr>
						...
						<td>
							...
							<a href='delete.php?id=".$row['id']."'><button type='button' class='btn btn-primary'>Remove</button></a>
						</td>
					</tr>";
				}
			} else {
